...
namespace Fiorella_second.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterVM register)
        {
            ...
            Email.SendEmail("magoo.everywehere123@gmail.com", newUser.Email, confirmationLink, "xwgsajtczcfdpizw", "Email Confirmation");
            #region
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordVM forgotPassword)
         {
           ...
           var confirmationLink = Url.Action(nameof(ResetPassword), "Auth", new { token, email = user.Email }, Request.Scheme);
            ...
            Email.SendEmail("tural.memmedzade025@gmail.com", user.Email, confirmationLink, "xwgsajtczcfdpizw", "Reset Password");
        ...
        public async Task<IActionResult> ChangeEmail(ChangeMailVM changeMail)
        {
            ...
            if (changetPassResult.Succeeded)
            {
                Email.SendEmail("tural.memmedzade025@gmail.com", user.Email, "Your Mail Is Changed", "xwgsajtczcfdpizw", "Fiorello-Change Mail");
